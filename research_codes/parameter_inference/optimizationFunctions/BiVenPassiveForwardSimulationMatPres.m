...
abaqus_command = optimize_opt.abaqus_command;
                                          
%% regenerate updated abaqus input file
abaqusInputFileUpdate_MatModel(optimize_opt, A, B, Af, Bf, An, Bn, Afs, Bfs, ...
                                        Ca_RV, press);
[status, result] = RunAbaqusJobFromMatlab(abaqus_command, abaqusSimulationDir, abaqus_inputfile, ...
...
%     plot(  (strain_segs(7:30) + strain_segs_LVEpi(7:30))/2, 'b--');
    ...
    ResSim.ResVol.LV_vol_ori = BiVentricleVolume.LV_early_diastole;
    ResSim.ResVol.LV_vol_update = 0;
    ResSim.ResVol.EPI_vol_ori = 0;
    ResSim.ResVol.RV_vol_ori = BiVentricleVolume.RV_early_diastole;
    ResSim.ResVol.RV_vol_update = 0;
    ResSim.ResVol.wall_vol_ori = 0;
    ResSim.ResVol.wall_vol_update = 0;
    %ResSim.strain_segs = [];
