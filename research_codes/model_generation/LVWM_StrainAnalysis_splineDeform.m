...
sliceSelected = 10; %%% the range is from 1 to usuableSXSlice
% if reversedSequence
...
TimeEndOfSystole = SXSliceSorted(sliceSelected).TimeEndOfSystole; 
TimeEndOfDiastole = SXSliceSorted(sliceSelected).TimeEndOfDiastole; 
TimeEarlyOfDiastole =  SXSliceSorted(sliceSelected).TimeEarlyOfDiastole;
...
for InstanceNo = 1 : totalInstanceNum
    ...
    imData = SXSliceSorted(1,sliceSelected).SXSlice(imInstance).imData;
    imInfo = SXSliceSorted(1,sliceSelected).SXSlice(imInstance).imInfo;
