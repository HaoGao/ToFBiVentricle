...
for imIndex = 1 : usuableSXSlice
    endo_c = DataSegSA(imIndex).endo_cReal;
%     epi_c = DataSegSA(imIndex).epi_cReal;
    plot3(endo_c(1,:),endo_c(2,:), endo_c(3,:),'LineStyle', '--', 'Color', 'b', 'LineWidth',1);
%     plot3(epi_c(1,:),epi_c(2,:), epi_c(3,:),'LineStyle', '-', 'Color', 'r', 'LineWidth',2);
end
...
%     plot3(endo_c(1,:),endo_c(2,:), endo_c(3,:),'LineStyle', '-', 'Color', 'b', 'LineWidth',2);
    curve3Dh = plot3(endo_c(1,:),endo_c(2,:), endo_c(3,:),'LineStyle', '-', 'Color', 'r', 'LineWidth',1);
end
...
endo_cReal(1,:) = endo_cReal(1,:) + vec_to_move(1);
endo_cReal(2,:) = endo_cReal(2,:) + vec_to_move(2);
endo_cReal(3,:) = endo_cReal(3,:) + vec_to_move(3);
...
figure(h3D_LAAdjust);
if exist('curve3Dh', 'var')
    delete(curve3Dh);
end
 hold on; axis equal;
curve3Dh = plot3(endo_cReal(1,:),endo_cReal(2,:), endo_cReal(3,:),'LineStyle', '-', 'Color', 'r', 'LineWidth',2); hold on;

if handles.radioBtn_LVOT.Value == 1
     DataSegLA(handles.LVOT_index).endo_cReal = endo_cReal;
     DataSegLA(handles.LVOT_index).epi_cReal = epi_cReal;
elseif handles.radioBtn_4CH.Value == 1
     DataSegLA(handles.FourCH_index).endo_cReal = endo_cReal;
     DataSegLA(handles.FourCH_index).epi_cReal = epi_cReal;
elseif handles.radioBtn_1CH.Value == 1
     DataSegLA(handles.OneCH_index).endo_cReal = endo_cReal;
