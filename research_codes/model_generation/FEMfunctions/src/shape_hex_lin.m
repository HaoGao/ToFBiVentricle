...
function [xquad, shape,dshape,j] = shape_hex_lin(x,coor)
%shape-funktion für 3d-8-Knotenelemente mit lin. Ansaetzen

%%%input
%% x [8 3]: single element matrix with coordinates
%%coor:       quadrature point position

%%output
%%xquad [1,3]: physical position of the quadrature point
%%shape [8]: shape function evaluated at quadrature points
%%dshape [8 3]: derivative function evaluated at shape function 
%%j: determination of Jacobian
