...
C- Displacement DATA, out order
			...
			Fg_G(:,:)=0.0D0
	        open(403,FILE='D:/DBGuan/LianTian/RatHeart/AbaqusFile/Growth/FGPI_Gff.txt',STATUS='OLD')
            read(403,*) SDVelement
			...
			Fg_C(:,:)=0.0D0
	        open(404,FILE='D:/DBGuan/LianTian/RatHeart/AbaqusFile/Growth/FGPI_Gss.txt',STATUS='OLD')
            read(404,*) SDVelement
            write(*,*) 'total data to read: n = ', SDVelement
			...
			Fg_M(:,:)=0.0D0
	        open(405,FILE='D:/DBGuan/LianTian/RatHeart/AbaqusFile/Growth/FGPI_Gnn.txt',STATUS='OLD')
            read(405,*) SDVelement
            write(*,*) 'total data to read: n = ', SDVelement
