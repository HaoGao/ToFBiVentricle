...
C- Displacement DATA, out order
			...
			FrG(:,:)=0.0D0
	        open(401,FILE='/home/pgrad2/2306902g/DBGuan/DB/UMAT/Growth_heart/Con_Eccentric_SAM/Fr_G.txt',STATUS='OLD')
            read(401,*) SDVelement
			...
			FrM(:,:)=0.0D0
	        open(409,FILE='/home/pgrad2/2306902g/DBGuan/DB/UMAT/Growth_heart/Con_Eccentric_SAM/Fr_M.txt',STATUS='OLD')
            read(409,*) SDVelement
            write(*,*) 'total data to read: n = ', SDVelement
			...
			FrC(:,:)=0.0D0
	        open(408,FILE='/home/pgrad2/2306902g/DBGuan/DB/UMAT/Growth_heart/Con_Eccentric_SAM/Fr_C.txt',STATUS='OLD')
            read(408,*) SDVelement
            write(*,*) 'total data to read: n = ', SDVelement
			...
			Fg_M(:,:)=0.0D0
	        open(402,FILE='/home/pgrad2/2306902g/DBGuan/DB/UMAT/Growth_heart/Con_Eccentric_SAM/FGPI_M.txt',STATUS='OLD')
            read(402,*) SDVelement
            write(*,*) 'total data to read: n = ', SDVelement
			...
			Fg_G(:,:)=0.0D0
	        open(403,FILE='/home/pgrad2/2306902g/DBGuan/DB/UMAT/Growth_heart/Con_Eccentric_SAM/FGPI_G.txt',STATUS='OLD')
            read(403,*) SDVelement
            write(*,*) 'total data to read: n = ', SDVelement
			...
			Fg_C(:,:)=0.0D0
	        open(404,FILE='/home/pgrad2/2306902g/DBGuan/DB/UMAT/Growth_heart/Con_Eccentric_SAM/FGPI_C.txt',STATUS='OLD')
            read(404,*) SDVelement
            write(*,*) 'total data to read: n = ', SDVelement
			...
			Fg_sum(:,:)=0.0D0
	        open(405,FILE='/home/pgrad2/2306902g/DBGuan/DB/UMAT/Growth_heart/Con_Eccentric_SAM/FGPI_sum.txt',STATUS='OLD')
            read(405,*) SDVelement
            write(*,*) 'total data to read: n = ', SDVelement
...
c-				write(*, *) Fg_sum(i,1),Fg_sum(i,2),Fg_sum(i,3),Fg_sum(i,4)
			...
			Fd(:,:)=0.0D0
	        open(410,FILE='/home/pgrad2/2306902g/DBGuan/DB/UMAT/Growth_heart/Con_Eccentric_SAM/FibreD.txt',STATUS='OLD')
            read(410,*) SDVelement
            write(*,*) 'total data to read: n = ', SDVelement
